...
- [second-redis-connection.md](recipes/second-redis-connection.md) — `AddNamedCaching`: a complete second caching stack (caches, sets, locks, broadcast) on its own Redis server, picked by key.
