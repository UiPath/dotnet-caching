...
/// <summary>
/// Options for the multilayer queue-cache backing (the <c>InMemoryRedis</c> provider), shared by
/// all its collection kinds: a local in-process snapshot (L1) in front of the Redis set cache (L2).
